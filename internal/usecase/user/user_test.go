...
func TestService_Register(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			svc := New(userRepo, hasher, cache, emailSender, mocks.NewTokenValidator(t), mocks.NewTokenRevoker(t), 24*time.Hour, time.Hour, zap.NewNop())
...
func TestService_VerifyEmail(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			svc := New(userRepo, mocks.NewPasswordHasher(t), cache, mocks.NewEmailSender(t), mocks.NewTokenValidator(t), mocks.NewTokenRevoker(t), 24*time.Hour, time.Hour, zap.NewNop())
...
func TestService_RequestPasswordReset(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			svc := New(ur, mocks.NewPasswordHasher(t), cs, es, mocks.NewTokenValidator(t), mocks.NewTokenRevoker(t), 24*time.Hour, time.Hour, zap.NewNop())
...
func TestService_ResetPassword(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			svc := New(ur, h, cs, mocks.NewEmailSender(t), mocks.NewTokenValidator(t), tr, 24*time.Hour, time.Hour, zap.NewNop())
